...
public class ApiStorage implements TelegramApiStorage {
    ...
    public static final File AUTH_KEY_FILE = new File(System.getProperty("user.dir") + "/kotlobot.auth.key");
    public static final File NEAREST_DC_FILE = new File(System.getProperty("user.dir") + "/kotlobot.dc.save");
